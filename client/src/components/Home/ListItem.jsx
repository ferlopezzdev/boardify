...
const ListItem = ({ children, isActive = false, title }) => {
  ...
  return (
    <li className={`flex flex-row justify-start items-center select-none cursor-pointer p-4 ${bgColor} bg-opacity-100 rounded-tr-3xl rounded-br-3xl transition-all
